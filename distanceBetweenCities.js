 ...
 * @return {Array} cities (names and coordinates)
 */
 ...
 * @return {2D Array} city object tuples
 */
function compareDistances(cities) {
	var geolib = require('geolib');
	var halfOfEarthsCircumference = 20000000;
...
function printCities(cityTuples) {
	// in case there is more than one pair that has the same distance apart
